...
<html lang="ít">
	<head>
		...
		<link rel="stylesheet" href="css/footer-style.css?ts=<?=time()?>&quot">
	...
	<body>
		<footer>
			<div class="footer-content">
				<h3>BeerMeUp</h3>
				<p>BeerMeUp è una piattaforma di e-commerce creata appositamente per un progetto universitario. Tutti gli ordini effettuati non saranno realmente 
				...
				<div class="footer-bottom">
					<p>copyright &copy;2023 <a href="#">BeerMeUp</a></p>
