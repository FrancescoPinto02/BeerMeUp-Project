...
INSERT INTO style (style_name, traits)
VALUES ('American Pale Ale' , 'Le American Pale Ale si presentano fresche, chiare e luppolate, con unâadeguata quantita  di malto che le rende equilibrate e bevibili. La forte presenza del luppolo conferisce alle varieta  americane un ampio spettro di caratteristiche gustative. Sono birre di media gradazione, tendenti al luppolato ma pia accessibili rispetto alle IPA americane moderne. L aroma generalmente include note fruttate, floreali e speziate, il luppolo caratteristico si percepisce al naso. Malto: sostiene la decisa luppolatura e puo mostrare note speciali (pane, biscotto o caramello). Il dry-hopping (se presente) generalmente non domina il gusto e puo aggiungere note erbacee.');

INSERT INTO style (style_name, traits)
VALUES ('Lager' , 'Le Lager sono birre a bassa fermentazione, prodotte utilizzando lieviti del ceppo Saccharomyces carlsbergensis, scoperto in Danimarca da parte del produttore di birra Carlsberg (da cui il nome) e del ceppo Saccharomices pastorianus isolato dal tedesco Max Rees nel 1870. Questi lieviti hanno la caratteristica di essere attivi a partire da temperature piu basse rispetto ai Saccharomyces cerevisiae, ossia intorno a 10 Gradi. Inoltre durante la fermentazione i lieviti si depositano sul fondo del tino, da cui il termine bassa fermentazione (bottom fermentation) all opposto delle birre ad alta fermentazione i cui lieviti durante il processo risalgono sulla superficie del tino (top fermentation). Alla famiglia delle birre Lager appartengono molti stili di birra, come ad esempio le Pils sia Ceche che Tedesche, le Marzen e molte altre.');
...
INSERT INTO beer (brewery_id , style_id, beer_name, beer_description, color, ingredients, gradation, price, iva, stock, discount, img)
VALUES ('2', '4', 'Free Solo', 'Una Session IPA con una luppolatura di nuova generazione, gentile ma decisa, che presenta delle note tropicali su una base di malto caratterizzata dall uso di frumento, fiocchi d orzo e malto di avena. Un sorprendente mix di cereali e luppoli che lasciano in bocca il sapore della liberta , dei viaggi e delle grandi imprese, di quelle che si celebrano al pub.' , 'Bionda' , 'Orzo, Frumento, Avena', '3.5' , '6.00', '22', '30', '20', LOAD_FILE('C:/birre/Beer8.PNG'));

INSERT INTO beer (brewery_id , style_id, beer_name, beer_description, color, ingredients, gradation, price, iva, stock, discount, img)
VALUES ('2', '3', 'Peler', 'La nostra Italian Pilsner punta sull equilibrio tra la parte maltata, le tipiche note di crosta di pane e miele, e una luppolatura fatta di sole varieta  mitteleuropee. Come il vento del Garda dal quale prende il nome, le sue note floreali ed erbacee enfatizzate da un leggero dry hopping, ti trasporteranno in una nuova esperienza da bere. Tu spiega le vele, il resto lo fara  lei!.' , 'Bionda' , 'Orzo', '4.8' , '4.50', '22', '20', '0', LOAD_FILE('C:/birre/Beer9.PNG'));

INSERT INTO beer (brewery_id , style_id, beer_name, beer_description, color, ingredients, gradation, price, iva, stock, discount, img)
VALUES ('2', '6', 'Vivienne', 'Ne evoca il carattere, lo stile ed anche il nome. Il suo colore ambrato carico di note rossastre racchiude un bouquet di profumi che vanno dal caramello alla frutta secca, passando per una invitante fragranza di biscotti. Un omaggio all impavida regina della moda punk inglese.' , 'Scura' , 'Orzo', '4.8' , '4.50', '22', '20', '10', LOAD_FILE('C:/birre/Beer10.PNG'));
