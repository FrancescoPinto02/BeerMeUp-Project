...
CREATE TABLE payment_method(
	...
	cvv VARCHAR(4) NOT NULL CHECK(cvv>0),
...
VALUES ('Stout' , 'Delicate, con un corpo medio ed una carbonatazione moderata, evidenziano note di cioccolato e caffè, con toni secondari di cacao o cereale torrefatto. La cremosita� e il tenue fruttato/luppolato donano equilibrio a queste birre.');
...
INSERT INTO beer (brewery_id , style_id, beer_name, beer_description, color, ingredients, gradation, price, iva, stock, discount, img)
VALUES ('2', '3', 'Peler', 'La nostra Italian Pilsner punta sull’equilibrio tra la parte maltata, le tipiche note di crosta di pane e miele, e una luppolatura fatta di sole varieta� mitteleuropee. Come il vento del Garda dal quale prende il nome, le sue note floreali ed erbacee enfatizzate da un leggero dry hopping, ti trasporteranno in una nuova esperienza da bere. Tu spiega le vele, il resto lo farà lei!.' , 'Bionda' , 'Orzo', '4.8' , '4.50', '22', '20', '0', LOAD_FILE('C:/birre/Beer9.PNG'));
