...
VALUES ('Antikorpo', 'Antikorpo Brewing a un giovane birrificio italiano ânato nel bel mezzo di una pandemia, come lo descrive il birraio stesso, Davide Galliussi che, con Cristina Mirizzi, ha creato il progetto nei primi mesi del 2020, da una costola dello storico birrificio Cittavecchia di Sgonico (TS). In pochi anni il birrificio Ã¨ cresciuto alla velocita  della luce, producendo birre che ti invogliano ad un secondo sorso, dagli stili molto apprezzati e in voga, tra i quali ritroviamo per esempio Pacific Pale Ale, West Coast Double IPA, ma anche basse fermentazioni davvero ben riuscite. Oltre ad una particolare attenzione verso il mondo gluten free che, diciamocelo, gli riesce molto bene! Birre dal forte carattere, indimenticabili, in lattina, dalla veste grafica fortemente riconoscibile, grazie anche all`eccentrica linea di grafiche realizzate da tatuatori di fama internazionale.' , 'Italia' );
...
VALUES ('Stout' , 'Delicate, con un corpo medio ed una carbonatazione moderata, evidenziano note di cioccolato e caffÃ¨, con toni secondari di cacao o cereale torrefatto. La cremosita  e il tenue fruttato/luppolato donano equilibrio a queste birre.');
...
INSERT INTO style (style_name, traits)
VALUES ('American Pale Ale' , 'Le American Pale Ale si presentano fresche, chiare e luppolate, con unâadeguata quantitÃ  di malto che le rende equilibrate e bevibili. La forte presenza del luppolo conferisce alle varieta  americane un ampio spettro di caratteristiche gustative. Sono birre di media gradazione, tendenti al luppolato ma pia accessibili rispetto alle IPA americane moderne. Lâaroma generalmente include note fruttate, floreali e speziate, il luppolo caratteristico si percepisce al naso. Malto: sostiene la decisa luppolatura e puÃ² mostrare note speciali (pane, biscotto o caramello). Il dry-hopping (se presente) generalmente non domina il gusto e puo aggiungere note erbacee.');

INSERT INTO style (style_name, traits)
VALUES ('Lager' , 'Le Lager sono birre a bassa fermentazione, prodotte utilizzando lieviti del ceppo Saccharomyces carlsbergensis, scoperto in Danimarca da parte del produttore di birra Carlsberg (da cui il nome) e del ceppo Saccharomices pastorianus isolato dal tedesco Max Rees nel 1870. Questi lieviti hanno la caratteristica di essere attivi a partire da temperature piÃ¹ basse rispetto ai Saccharomyces cerevisiae, ossia intorno a 10 Â°C. Inoltre durante la fermentazione i lieviti si depositano sul fondo del tino, da cui il termine bassa fermentazione (âbottom fermentationâ) allâopposto delle birre ad alta fermentazione i cui lieviti durante il processo risalgono sulla superficie del tino (âtop fermentationâ). Alla famiglia delle birre Lager appartengono molti stili di birra, come ad esempio le Pils sia Ceche che Tedesche, le MÃ¤rzen e molte altre.');
...
INSERT INTO beer (brewery_id , style_id, beer_name, beer_description, color, ingredients, gradation, price, iva, stock, discount, img)
VALUES ('1', '4', 'Lowrider', 'La Antikorpo Lowrider Ã¨ una birra in stile Ipa completamente gluten free. I luppoli regalano a questa birra profumi e sapori resinosi e balsamici, lasciando perÃ² anche spazio alle calde note tropicali tipiche dello stile: guava e maracuja la fanno da padrona. Ã una birra dissetante, gustosa e con una buona gradazione. Il suo finale si contraddistingue per un amaro deciso che ricorda il  pompelmo.' ,'Bionda' , 'Orzo', '5.8' , '4.70', '22', '25', '0', LOAD_FILE('C:/birre/Beer5.PNG'));

INSERT INTO beer (brewery_id , style_id, beer_name, beer_description, color, ingredients, gradation, price, iva, stock, discount, img)
VALUES ('2', '5', 'Moxie', 'La sua ricetta si ispira ai classici della Craft Beer Revolution. Presenta una luppolatura che unisce le moderne Apa e le pale ale old school con le caratteristiche note agrumate e resinose. Dal tipico colore ambrato, in bocca si distingue per la scorrevolezza e lâequilibrio tra una nota di caramello e lâapporto dei luppoli. Moxie significa Grinta, la quintessenza di Impavida: da bere sempre proprio come una buona APA dovrebbe essere.' , 'Rossa' , 'Orzo, Frumento', '5.5' , '4.60', '22', '25', '0', LOAD_FILE('C:/birre/Beer6.PNG'));

INSERT INTO beer (brewery_id , style_id, beer_name, beer_description, color, ingredients, gradation, price, iva, stock, discount, img)
VALUES ('2', '4', 'Chain Breaker', 'Ã la nostra India Pale Ale: una birra caratterizzata da un blend di luppoli americani classici e moderni, che uniscono le note agrumate e resinose con la parte tropicale delle IPA di ultima generazione. Il tutto innestato in una base di malto pale che le conferisce un corpo adeguato a supportarne la luppolatura. Non farti ingannare dal suo colore dorato, la Chain Breaker Ã¨ una vera rivoluzione. Ã nata per rompere gli schemi, fallo anche tu!' , 'Bionda' , 'Orzo', '6.1' , '5.50', '22', '20', '10', LOAD_FILE('C:/birre/Beer7.PNG'));

INSERT INTO beer (brewery_id , style_id, beer_name, beer_description, color, ingredients, gradation, price, iva, stock, discount, img)
VALUES ('2', '4', 'Free Solo', 'Una Session IPA con una luppolatura di nuova generazione, gentile ma decisa, che presenta delle note tropicali su una base di malto caratterizzata dallâuso di frumento, fiocchi dâorzo e malto dâavena. Un sorprendente mix di cereali e luppoli che lasciano in bocca il sapore della libertÃ , dei viaggi e delle grandi imprese, di quelle che si celebrano al pub.' , 'Bionda' , 'Orzo, Frumento, Avena', '3.5' , '6.00', '22', '30', '20', LOAD_FILE('C:/birre/Beer8.PNG'));

INSERT INTO beer (brewery_id , style_id, beer_name, beer_description, color, ingredients, gradation, price, iva, stock, discount, img)
VALUES ('2', '3', 'Peler', 'La nostra Italian Pilsner punta sullâequilibrio tra la parte maltata, le tipiche note di crosta di pane e miele, e una luppolatura fatta di sole varieta  mitteleuropee. Come il vento del Garda dal quale prende il nome, le sue note floreali ed erbacee enfatizzate da un leggero dry hopping, ti trasporteranno in una nuova esperienza da bere. Tu spiega le vele, il resto lo farÃ  lei!.' , 'Bionda' , 'Orzo', '4.8' , '4.50', '22', '20', '0', LOAD_FILE('C:/birre/Beer9.PNG'));

INSERT INTO beer (brewery_id , style_id, beer_name, beer_description, color, ingredients, gradation, price, iva, stock, discount, img)
VALUES ('2', '6', 'Vivienne', 'Ne evoca il carattere, lo stile ed anche il nome. Il suo colore ambrato carico di note rossastre racchiude un bouquet di profumi che vanno dal caramello alla frutta secca, passando per unâinvitante fragranza di biscotti. Un omaggio all impavida regina della moda punk inglese.' , 'Scura' , 'Orzo', '4.8' , '4.50', '22', '20', '10', LOAD_FILE('C:/birre/Beer10.PNG'));
